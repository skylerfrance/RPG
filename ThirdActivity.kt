...
class ThirdActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enemyNameView3.text = thirdEnemy.name
        enemyHealthView3.text = thirdEnemy.health.toString()
        enemyActionsView3.text = "${thirdEnemy.name} approaches you with a \n '${thirdEnemy.warcry}'"


        playerHealthView3.text = myPlayerLvl3.health.toString()
        playerAttackView3.text = "0 - ${myPlayerLvl3.attack-1}"
        playerActionsView3.text = "You wait while staying alert..."
    }
    ...
    fun attackButtonTapped(view: View) {
        ...
        enemyHealthView3.text = thirdEnemy.health.toString()
        if (ourAttack == 0) {
            playerActionsView3.text = "You attacked and missed."
        }
        if (theirAttack == 0) {
            enemyActionsView3.text = "They attacked and missed."
        }
        playerActionsView3.text = "You attacked and dealt $ourAttack damage"
        enemyActionsView3.text = "They attacked and dealt $theirAttack damage"
    ...
    fun defendButtonTapped(view: View){
        ...
        playerActionsView3.text = "You attacked while defending and dealt $ourAttack damage"
        enemyActionsView3.text = "They attacked you defending and dealt $theirAttack damage"
        // defeated enemy, move on
        val dialogBuilder = AlertDialog.Builder(this)
        if (thirdEnemy.health <= 0) {
            dialogBuilder.setMessage("${thirdEnemy.name} has been defeated! \n Your health has been replenished. \n You leveled up! \n Congratulations! Floor 1 is clear.")
